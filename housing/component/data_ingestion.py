...
class DataIngestion():
    ...
    def download_housing_data(self) -> str:
        try:
            ...
            housing_file_name=os.path.basename(dataset_download_url) #housing.tgz
            ...
            logging.info('Download File Completed Successfully')
    ...
    def extract_tgz_file(self,tgz_file_path:str):
        try:
            ...
            with tarfile.open(name=tgz_file_path,mode='r') as housing_tgz_file_obj:
    ...
    def split_data_as_train_test(self)->DataIngestionArtifact:
        try:
            ...
            data_ingestion_artifact= DataIngestionArtifact(train_data_file_path=train_file_path, 
