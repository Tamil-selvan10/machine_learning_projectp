...
class Configuration:
    ...
    def get_data_ingestion_config(self)->DataIngestionConfig:
        try:
            ...
            ingested_data_dir=data_ingestion_info[DATA_INGESTION_INGESTED_DIR_NAME_KEY]
    ...
    def get_training_pipeline_config(self)->TrainingPipelineConfig  :
        try:
            ...
            artifact_dir=training_pipeline_config[TRAINING_PIPELINE_ARTIFACT_DIR_KEY]
            artifact_dir_path=os.path.join(ROOT_DIR,pipeline_name,artifact_dir)

            training_pipeline_config_info=TrainingPipelineConfig(artifact_dir=artifact_dir_path)
            
            logging.info(f'Training Pipeline Config:{training_pipeline_config_info}')

            return training_pipeline_config_info
